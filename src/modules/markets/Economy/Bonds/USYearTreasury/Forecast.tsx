      ...
      <div className="">
        <div className="flex max-md:flex-col-reverse md:justify-between">
          <div>
            ...
            <p className="text-lg text-[#747474]">US30Y:Tradeweb</p>
            <p className="mt-2 text-sm text-[#BABABA]">RT Quote | Exchange</p>
            <p className="mt-5 text-sm font-bold text-[#171717]">
              Yield | 11:06 AM EST
            </p>
            <p className="mt-3 text-5xl font-bold text-[#171717]">
              4.306%{" "}
              <span className="text-3xl font-bold text-[#008456]">+0.001</span>
            </p>
          </div>

          <div className="flex flex-wrap h-fit gap-5 max-md:mb-5">
            <button className="flex items-center gap-3 border border-[#002F6C] px-4 py-3 text-xs font-bold text-[#002F6C]">
              EXPORT
              <svg
                width={13}
                height={12}
            ...
            <button className="flex items-center gap-3 border border-[#002F6C] text-xs font-bold text-[#002F6C]">
              <div className="flex items-center gap-1 bg-[#CE2B2B] p-2 text-white m-1">
                LIVE
                <MdOutlinePlayCircle className="h-4 w-4" />
              </div>
              <span className="inline-block pr-4 py-3">MONEY MOVERS</span>
            </button>
          </div>
        </div>

        <div className="mt-1o relative max-md:h-[200px] h-[320px] w-full">
          <Image
        ...
        <div className="mt-14">
          <Tab.Group>
                    ...
                    {({ selected }) => (
                      <button
                        className={`w-full border-b-2 pb-2 text-lg font-bold uppercase ${
                          selected
                            ? "border-primary-base text-[#252525]"
                            : "border-[#C4C4C4] text-[#747474]"
                        }`}
                      >
                        {market}
                      </button>
            ...
            <Tab.Panels>
              <Tab.Panel>
                <div className="">
                  <p className="mb-1 font-bold text-[#002F6C]">KEY STATS</p>
                  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-x-6">
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">Yield Open</p>
                      <p className="font-bold text-[#171717]">{summary.open}</p>
                    </div>
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">Price</p>
                      <p className="font-bold text-[#171717]">
                        {summary.price}
                      </p>
                    </div>
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">
                        Price Day High
                      </p>
                      <p className="font-bold text-[#171717]">
                        {summary.dayHigh}
                    ...
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">Price Change</p>
                      <p className="font-bold text-[#171717]">
                        {summary.change}
                      </p>
                    </div>
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">price Day Low</p>
                      <p className="font-bold text-[#171717]">
                        {summary.dayLow}
                      </p>
                    </div>
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">yield Day Low</p>
                      <p className="font-bold text-[#171717]">
                        {summary.dayLow}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">Coupon</p>
                      <p className="font-bold text-[#171717]">
                        {summary.marketCap}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between border-b border-[#D9D9D9] py-3">
                      <p className="capitalize text-[#747474]">Maturity</p>
                      <p className="font-bold text-[#171717]">
        ...
        {/* divider */}
        <div className="mb-4 mt-8 h-[6px] w-full bg-[#1D1D1D]"></div>
          ...
          <div className="mt-3">
            {financialContent.map((content, index) => (
              ...
              >
                ...
                <p className="ml-6 text-xs font-bold text-[#636363]">
                  {content.source}
                </p>
              </div>
            ))}
