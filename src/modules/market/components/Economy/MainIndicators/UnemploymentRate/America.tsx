...
async function getData() {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE_URL}/economy/unemploymentRate`
  );
        ...
        {data?.data && (
          <>
            ...
            <p className="mt-14 border border-[#DDDDDD] px-5 py-6">
              ...
              forecasts, statistics and historical data charts for -
              Unemployment Rate. This page provides values for Unemployment Rate
              reported in several countries. The table has current values for
              Unemployment Rate, previous releases, historical highs and record
              lows, release frequency, reported unit and currency plus links to
