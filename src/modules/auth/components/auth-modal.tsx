  ...
  return (
    <Dialog open={loginModalOpen} onOpenChange={handleClose}>
      <Container>
        <DialogContent
          hideCloseBtn
          className=" space-y-8 bg-main-gray-800 px-10 pb-24 pt-12 max-sm:w-[min(95%,30rem)] sm:px-16 sm:pt-20 "
        >
          <img
          ...
          <DialogHeader className=" space-y-0 ">
            <DialogTitle className=" mx-auto w-full max-w-[18rem] text-center text-2xl font-bold ">
          ...
          <div className=" flex flex-col gap-y-4 ">
            ...
            <Separator className=" bg-main-gray-300 dark:bg-main-gray-300 " />
