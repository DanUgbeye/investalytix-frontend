...
export default function GDPLayout({
  ...
  const markets = [
    ...
    {
      label: "STATS",
      href: "/markets/economy/consumer/spending/stats",
    },
    {
      label: "FORECAST",
      href: "/markets/economy/consumer/spending/forecast",
    },
  ];
  ...
  return (
    <>
      <MarketHeader name="United States Consumer Spending" active="ECONOMY" />
