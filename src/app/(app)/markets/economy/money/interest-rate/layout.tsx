...
export default function MoneyLayout({
  ...
  const markets = [
    ...
    {
      label: "STATS",
      href: "/markets/economy/money/interest-rate/stats",
    },
    {
      label: "FORECAST",
      href: "/markets/economy/money/interest-rate/forecast",
    },
  ];
  ...
  return (
    <>
      <MarketHeader name="United States INTEREST RATE" active="ECONOMY" />
