    ...
    <main>
      ...
      <Container className="max-w-[1440px]">
        {data.map((about, index) => (
          ...
          >
            <div className="h-full rounded-xl bg-gray-200 xl:min-h-[400px]"></div>
