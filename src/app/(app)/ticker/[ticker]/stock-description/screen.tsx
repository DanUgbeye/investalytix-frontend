    ...
    <section className="space-y-8 pb-8">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(9rem,1fr))] gap-6 p-4 xl:grid-cols-4 xl:justify-between">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Prev Close</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Day High</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">52 Week High</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">52 Week Low</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Average Volume</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">EPS</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">PE Ratio</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Earnings Date</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Shares Out</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Dividend</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm opacity-80">Dividend Yield (TTM)</span>
