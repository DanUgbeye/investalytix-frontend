    ...
    <section className=" space-y-8 ">
      <div className=" grid grid-cols-1 gap-8 xl:grid-cols-3   ">
        <div className=" w-full ">
          <div className=" grid grid-cols-[1fr,auto] items-center justify-between gap-x-3 border-b py-2 text-sm dark:border-b-gray-700 ">
      ...
      <div className=" grid gap-10 xl:grid-cols-[auto,1fr] ">
        ...
        <div className=" min-w-60 space-y-4 ">
          ...
          <div className=" grid grid-cols-[auto,auto] gap-x-3 ">
            <div className=" flex w-full flex-col gap-y-2 border-b py-2 dark:border-b-gray-700 ">
          ...
          <div className="  ">
            ...
            <div className=" divide-y dark:divide-gray-700 ">
              {Array(3)
                ...
                .map((_, index) => {
                  return (
                    <NewsCard className="" key={`news-${index}`} hideContent />
                  );
                })}
            </div>
          </div>
