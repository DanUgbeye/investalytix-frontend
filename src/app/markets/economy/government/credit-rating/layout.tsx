...
export default function CreditRatingLayout({
  children,
}: Readonly<{
  ...
  const markets = [
    ...
    {
      label: "STATS",
      href: "/markets/economy/government/credit-rating/stats",
    },
    {
      label: "FORECAST",
      href: "/markets/economy/government/credit-rating/forecast",
    },
  ];
  ...
  return (
    <>
      <MarketHeader name="UNITED States - credit rating" active="ECONOMY" />
